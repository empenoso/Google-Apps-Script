...
*[Google Apps Script](Google Calendar_Birthdays.gs) that creates events (birthdays and anniversaries), indicating the past years in the calendar.*
...
![Google Calendar_Birthdays and anniversaries with dates for your calendar](Google Calendar_Birthdays.png)

# 2\. Google Calendar_A child’s age in months and years, with a monthly reminder.gs :baby:
*[Google Apps Script](Google Calendar_A child’s age_v1.gs) is great for all young fathers - it shows how many months and years the child is old, with a monthly reminder.*
...
![Google Calendar_A child’s age in months and years, with a monthly reminder](Google Calendar_A child’s age_v1.png)
